...
static const int viewontag          = True;     /* Switch view on tag switch */
static const int user_bh            = 30;        /* 0 means that dwm will calculate bar height, >= 1 means dwm will user_bh as bar height */
static const char *fonts[]          = { "Iosevka-Term:size=11:antialias=true:autohint=true" };

static const char dmenufont[]       = "Iosevka-Term:size=11";
static const unsigned int baralpha = 0xd0;
static const unsigned int borderalpha = OPAQUE;

#include "/home/cjg/themes/monokai/colors-wal-dwm.h"
#include "/home/cjg/suckless/tags/siji.h"
...
static const Rule rules[] = {
	...
	{ "St",      NULL,     NULL,           0,         1,		1,          1,           0,        -1 },
	{ NULL,      NULL,     "Event Tester", 0,         0,		0,          0,           1,        -1 }, /* xev */
  { "Pcmanfm", NULL,     NULL,           1 << 4,    0,		0,          0,          -1,	       -1 },
  { "Hexchat", NULL,     NULL,           1 << 5,    0,		0,          0,          -1,	       -1 },
...
static const char *ncmpcpp[] = { "ncmpcpp", NULL};
...
static Button buttons[] = {
  ...
  { ClkStatusText,        0,              Button1,        spawn,          {.v = mpctgl } },
  { ClkStatusText,        0,              Button2,        spawn,          {.v = mpcprv } },
  { ClkStatusText,        0,              Button3,        spawn,          {.v = mpcnxt } },
